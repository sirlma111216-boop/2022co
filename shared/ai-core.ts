...
SUGGEST에는 선생님의 문장을 살리면서 고친 완성 문장 하나만 제시합니다.`,
  ...
  inquiry: `이번 점검 대상은 「가장 강한 탐구질문 하나」입니다.
- 중심은 '가장 강한 탐구질문(핵심)'입니다. 이것부터 봅니다.
- 확인 / 연결 / 확장 질문 세 개는 선택 항목입니다. 비어 있어도 지적하지 마십시오.
  적혀 있을 때만, 서로 다른 단계인지 함께 봅니다.
- 한 단어로 답이 끝나는 질문(정답 맞히기)이면 분명히 지적합니다.
- 학생마다 다른 근거가 나올 여지가 있는지, 처음 배운 상황을 넘어 다른 상황으로 이어지는지 봅니다.
- 약하면 '만약 ~라면?', '~을 정한다면 무엇을 근거로?' 형태를 제안합니다.
- 그 질문이 앞서 정한 영속적 이해와 이어지는지 봅니다.
SUGGEST에는 핵심 질문을 고쳐 쓴 완성된 질문 하나를 제시합니다.`,
...
const FIELD_LABEL: Record<string, string> = {
  ...
  original: "처음 떠오른 질문",
  keyInquiry: "가장 강한 탐구질문(핵심)",
  coreAction: "성취기준이 요구하는 핵심 행동",
  fact: "확인 질문",
  concept: "연결 질문",
  debate: "확장·논쟁 질문",
  g: "GRASPS · Goal 목표",
